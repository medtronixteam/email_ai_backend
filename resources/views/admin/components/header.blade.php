                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="d-flex mb-1">
                                    <div class="flex-shrink-0"><img src="{{url(auth()->user()->profile_photo)}}"
                                            alt="user-image" class="user-avtar wid-35"></div>
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1">{{auth()->user()->name}} 🖖</h6><span>{{auth()->user()->username}}</span>
                                    </div>
                                </div>
                                ...
                                <p class="text-span">Manage</p><a href="/profile" class="dropdown-item"><span><svg
                                            class="pc-icon text-muted me-2">
